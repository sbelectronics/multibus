...
; Ported to ISIS-II
;
; Added SYSTEM to exit back to ISIS
;
; Scott Baker, https://www.smbaker.com/, June 2024
;
;==============================================================================
;
...
; BASIC CODE COMMENCES
        ...
        ORG     3680H           ; <<<< Modified to allow for ACIA Tx/Rx on RST6.5
...
OUTIT:  ;CALL    OUTC            ; Output the character entered    XXX SMBAKER - ISIS already echos input
        JP      MORINP          ; Get another character
