...
;	MEMORY ALLOCATION
;
INITDP	EQU	MEMORY  ; START OF PROGRAM MEMORY
...
WORD:	DW	DOCOL
	...
	DW	BLK
	DW	AT
	DW	0000	; XXX smbaker called block here -- ensure this never happens...
	DW	BRAN	; ELSE
	DW	WORD2-$
WORD1:	DW	TIB
	DW	AT	; ENDIF
...
;
	...
	DW	WARM-7
COLD:	DW	DOCOL
;	DW	MTBUF			; XXX smbaker turn off a bunch of disk stuff
;	DW	ZERO,DENSTY
;	DW	STORE
;	DW	LIT,BUF1
;	DW	USE,STORE
