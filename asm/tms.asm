...
AGAIN:
	LDA	FLAGM				; Check mute flag first
	CPI	0FFH
	JZ	NOTM
	STA	PLAYED
	CALL	TMSMTE
...
HELP:	DB	'ARGS: C=CONTINUOUS, M=MUTE', 0DH, 0AH
        DB      '      (EXTERN) A=ACORN, Z=ZERO, G=GOOD MORN, T=TIME, S=SCOTT', 0DH, 0AH
	DB	'      (ROM) L=LETTERS, R=RUNNING ON COMPUTER', 0DH, 0AH, 0
